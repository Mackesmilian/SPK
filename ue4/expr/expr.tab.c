...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PLUS_OP = 3,                    /* PLUS_OP  */
  YYSYMBOL_MINUS_OP = 4,                   /* MINUS_OP  */
  YYSYMBOL_MULT_OP = 5,                    /* MULT_OP  */
  YYSYMBOL_DIV_OP = 6,                     /* DIV_OP  */
  YYSYMBOL_PAR_LEFT = 7,                   /* PAR_LEFT  */
  YYSYMBOL_PAR_RIGHT = 8,                  /* PAR_RIGHT  */
  YYSYMBOL_EOL = 9,                        /* EOL  */
  ...
  YYSYMBOL_sigfactor = 18,                 /* sigfactor  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "PLUS_OP", "MINUS_OP",
  "MULT_OP", "DIV_OP", "PAR_LEFT", "PAR_RIGHT", "EOL", "OTHER", "FPNUM",
  "MEM", "ASSIGN", "$accept", "lines", "line", "term", "sigfactor",
  "factor", YY_NULLPTR
};
...
{
       3,     0,     1,     0,     0,     0,    15,    17,     0,     2,
       0,    11,    12,    17,    13,    14,     0,     6,     0,     0,
       0,     0,     0,     5,    16,     4,     9,    10,     7,     8
};
